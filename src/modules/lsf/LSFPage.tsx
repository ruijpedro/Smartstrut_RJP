...
export default function LSFPage(){
 ...
 const checks=[
  ...
  {name:'Secção efetiva / encurvadura local e distorcional',status:'missing' as const,detail:'Obrigatória para dimensionamento final segundo EN 1993-1-3; ainda não calculada automaticamente.'},
  {name:'Contraventamento e diafragmas',status:'missing' as const,detail:'Definir placas, fitas, blocking e transferência de esforços de piso/cobertura.'},
