...
export function collectIntegratedSnapshot():IntegratedSnapshot{
 ...
 observations.push({id:'geo-link',area:'geotechnics',title:'Resultados geotécnicos persistentes',status:'missing',detail:'Os cálculos SPT/CPT/capacidade/assentamentos existem, mas ainda não são persistidos como cenário de projeto.',source:'Geotecnia'});
 observations.push({id:'cont-link',area:'containment',title:'Solução de contenção persistente',status:'missing',detail:'As soluções são calculáveis, mas falta guardar a alternativa escolhida e respetivas verificações.',source:'Contenção'});
 observations.push({id:'road-link',area:'roads',title:'Solução viária persistente',status:'missing',detail:'Traçado, drenagem e pavimentos precisam de um cenário guardado para entrar automaticamente na memória.',source:'Infraestruturas Viárias'});
